...
from_time = datetime(2021, 7, 9, 0, 0).timestamp()
to_time = datetime(2021, 10, 1, 0, 0).timestamp()
...
def main():
    ...
    frames, minim_date, maxim_date = get_coins_dataframe_timeseries(api, coin_ids, coin_symbols, data_type['market caps'], 
